    ...
    <div className="relative inline-block">
      <style>{`
        ...
        .rg-button {
          ...
          box-shadow: 0 0 35px rgba(70, 147, 150, 0.35), 0 4px 20px rgba(0,0,0,0.5);
          overflow: hidden;
        ...
        .rg-button:hover {
          ...
          box-shadow: 0 0 50px rgba(241, 255, 165, 0.5), 0 0 30px rgba(70, 147, 150, 0.6);
          --rg-pos-x: 0%;
          --rg-pos-y: 120%;
          --rg-spread-x: 110.24%;
          --rg-spread-y: 110.2%;
          ...
          --rg-border-color-1: hsla(320, 75%, 90%, 0.3);
          --rg-border-color-2: hsla(320, 50%, 90%, 0.5);
      ...
      <button 
        className={cn("rg-button group tracking-wider font-mono", className)} 
        type="button" 
        onClick={onClick}
        {...props}
      >
        ...
        <span className="rg-label font-bold text-white">
          {children}
        </span>
      </button>
    </div>
